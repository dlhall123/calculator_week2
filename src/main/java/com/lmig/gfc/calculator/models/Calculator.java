...
public class Calculator {
	...
	//returns a double (result) to the controller to sent to the view to display; type must be double in case of any decimals in the math
	//Switch statement sets the result variable to the correct result, based on operator passed
	...
	//Method to add a result to the Results ArrayList, which keeps track of all results
